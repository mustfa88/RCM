        ...
        <>
            ...
            <div className="col-3 dash">   
                ...
                <div className="col-9 right p-5 m-0">
                    ...
                    <nav className='my-5 d-flex w-100 justify-content-between align-items-center'>
                         <NavLink style={ style1 }  to='overview' className=' fw-bold'>Overview</NavLink>
                         <NavLink style = { style1 } to='details' className=' fw-bold'>Details</NavLink>
                         <NavLink style =  {style1}  to='tasks' className=' fw-bold link-task'>Tasks <span>2</span></NavLink>
                         <Link className='text-secondary fw-bold'>Milestones</Link>
                         <Link className='text-secondary fw-bold'>Files</Link>
                         <Link className='text-secondary fw-bold'>Comments</Link>
                         <Link className='text-secondary fw-bold'>Financial</Link>
                         <Link className='text-secondary fw-bold'>More</Link>
                    </nav>
